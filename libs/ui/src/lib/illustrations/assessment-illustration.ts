      ...
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
        @if (step === 1) {
          ...
          <path
            ...
            stroke="#006AFF" stroke-width="2" fill="#E8F0FE" stroke-linejoin="round"
          />
          <text x="24" y="24" text-anchor="middle" font-size="16" font-weight="700" fill="#006AFF">?</text>
        }
        @if (step === 2) {
          <!-- Target / overlapping rings -->
          <circle cx="24" cy="24" r="16" stroke="#34A853" stroke-width="2" fill="#E6F4EA"/>
          <circle cx="24" cy="24" r="10" stroke="#34A853" stroke-width="2" fill="white" opacity="0.7"/>
        ...
        @if (step === 3) {
          ...
          <path d="M14 32 Q20 26 26 24 Q32 20 36 14" stroke="#B06000" stroke-width="2" stroke-dasharray="3 2" fill="none" stroke-linecap="round"/>
        }
      </svg>
    </div>
  `,
