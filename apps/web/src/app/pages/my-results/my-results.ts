  ...
  template: `
    <div class="min-h-screen bg-ns-bg text-ns-text">
      <div class="mx-auto max-w-2xl px-6 py-16">
        <h1 class="m-0 text-3xl font-bold text-ns-text">My results</h1>
        <p class="mt-2 text-base leading-relaxed text-ns-muted">
        ...
        @if (loading()) {
          ...
          <div class="mt-16 flex flex-col items-center text-center">
            ...
            <h2 class="m-0 mt-4 text-xl font-semibold text-ns-text">
              No saved results yet.
            </h2>
            <p class="mt-2 max-w-xs text-base leading-relaxed text-ns-muted">
          ...
          <div class="mt-8 flex flex-col gap-4">
            @for (result of results(); track result.id) {
              <div
                class="rounded-ns-card border border-ns-border bg-ns-card shadow-ns p-5 hover:-translate-y-0.5 hover:shadow-ns-hover transition-all duration-base"
              >
                <div class="flex items-center justify-between gap-4">
                  ...
                  <a
                    ...
                    class="shrink-0 text-sm font-semibold text-ns-primary no-underline hover:underline"
                  >
                    View result →
                  </a>
                </div>
